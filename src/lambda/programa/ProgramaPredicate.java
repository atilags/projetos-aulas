...
public class ProgramaPredicate {
	...
	public static void main(String[] args) {
		...
		try (Scanner tec = new Scanner(System.in)) {
			...
			list.removeIf(p -> p.getPrice() >= valor);
			
			//list.removeIf(p -> p.getPrice() >= 100.0);
			
			//list.removeIf(new MeuPredicate());
			
			//list.removeIf(ProdutoPredicate::staticPredicate);
			
			//list.removeIf(ProdutoPredicate::naoStaticPredicate);
